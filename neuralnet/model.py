...
class DropNorm(nn.Module):
    def __init__(self, n_feats, dropout, keep_shape=False):
        ...
        self.dropout = nn.Dropout(dropout) # randomly change some element to 0 with percentage = dropout (prevent overfitting)
        self.norm = nn.LayerNorm(n_feats) # Normalizing using Layer normalization (prefered for RNN)
