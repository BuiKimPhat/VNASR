...
class SpeechModule(LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.scheduler["scheduler"].step(avg_loss)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-db', '--dist_backend', default='ddp', type=str,
                        help='which distributed backend to use. default ddp')
    ...
    parser.add_argument('--valid_every', default=0.25, required=False, type=int,
                        help='valid after every N iteration (default: 1/4 epoch)')
